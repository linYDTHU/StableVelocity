    ...
    for enc_name in enc_names:
        ...
        if encoder_type == 'mocov3':
            ...
            if 'reg' in encoder_type:
                encoder = torch.hub.load('facebookresearch/dinov2', f'dinov2_vit{model_config}14_reg', trust_repo=True)
            else:
                encoder = torch.hub.load('facebookresearch/dinov2', f'dinov2_vit{model_config}14', trust_repo=True)
            del encoder.head
