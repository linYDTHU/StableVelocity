...
from models.sit import TimestepEmbedder
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, t, y=None):
        ...
        if self.num_classes and y is None:
...
"""
inherit the model configs from https://arxiv.org/pdf/2105.05233
"""
MODEL_CONFIGS={
    "cifar-unconditional":{
        "in_channels": 3,
...
def get_unet_model(model_name, **kwargs):
    assert model_name in MODEL_CONFIGS.keys(), f"Model {model_name} not found in {MODEL_CONFIGS.keys()}"
